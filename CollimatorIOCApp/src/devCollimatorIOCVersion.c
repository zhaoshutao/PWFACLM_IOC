...
#include "CollimatorIOCVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = CollimatorIOCVERSION;
...
static lsidset devCollimatorIOCVersion = {
	{5, NULL, NULL, NULL, NULL}, read_string
};
epicsExportAddress(dset,devCollimatorIOCVersion);
